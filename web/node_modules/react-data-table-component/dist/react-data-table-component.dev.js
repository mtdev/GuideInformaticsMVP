...
var TableHeadRow = styled__default.div(_templateObject$3(), function (props) {
...
var TableRow = React.memo(function (_ref) {
  ...
  var extendedRowStyle = getRowStyle(row, conditionalRowStyles);
...
var TableColStyle = styled__default(Cell)(_templateObject2$4(), function (props) {
...
var Range = styled__default(Span)(_templateObject4$3());
var RowLabel = styled__default(Span)(_templateObject5$2());
...
var Pagination = function Pagination(_ref) {
  ...
  return React__default.createElement(React__default.Fragment, null, !noRowsPerPage && React__default.createElement(React__default.Fragment, null, React__default.createElement(RowLabel, null, rowsPerPageText), React__default.createElement(Select, {
...
var DataTable = React.memo(function (_ref) {
  var data = _ref.data,
      ...
      progressCentered = _ref.progressCentered,
  ...
  }, [data, selectableRowsPreSelectedField]); // recaclulate the pagination and currentPage if the data length changes
  ...
  }), data.length > 0 && !progressPending && React__default.createElement(TableStyle, {
    disabled: disabled,
    className: "rdt_Table"
  }, !noTableHead && React__default.createElement(TableHead, {
  ...
  }) : React__default.createElement(TableCol$1, null)), expandableRows && React__default.createElement(CellBase, {
    style: {
      flex: '0 0 56px'
    }
  ...
  }))), enabledPagination && React__default.createElement(TableFooter, {
    className: "rdt_TableFooter"
  }, React__default.createElement(Pagination$1, {
