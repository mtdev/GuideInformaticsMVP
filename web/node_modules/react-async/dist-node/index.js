...
const createInstance = (defaultOptions = {}, displayName = "Async") => {
  ...
  const AsyncInitial = props => React__default.createElement(Consumer, null, st => React__default.createElement(IfInitial, _extends({}, props, {
    state: st
  })));

  const AsyncPending = props => React__default.createElement(Consumer, null, st => React__default.createElement(IfPending, _extends({}, props, {
    state: st
  })));

  const AsyncFulfilled = props => React__default.createElement(Consumer, null, st => React__default.createElement(IfFulfilled, _extends({}, props, {
    state: st
  })));

  const AsyncRejected = props => React__default.createElement(Consumer, null, st => React__default.createElement(IfRejected, _extends({}, props, {
    state: st
  })));

  const AsyncSettled = props => React__default.createElement(Consumer, null, st => React__default.createElement(IfSettled, _extends({}, props, {
    state: st
  })));
...
const useAsync = (arg1, arg2) => {
  ...
  const getMeta = React.useCallback(meta => _objectSpread$2({
...
const useAsyncFetch = (resource, init, _ref = {}) => {
  ...
  const state = useAsync(_objectSpread$2({}, options, {
    [fn]: React.useCallback((arg1, arg2, arg3) => {
